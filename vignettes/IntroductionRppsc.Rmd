...
von_der_waals_plot <- plotCG(file = "proSeq", type= 2, circular_plot = TRUE)
von_der_waals_plot
polarity_plot <- plotCG(file = "proSeq", type= 3, circular_plot = TRUE)
polarity_plot
polarizability_plot <- plotCG(file = "proSeq", type= 4, circular_plot = TRUE)
polarizability_plot
desolvation_plot <- plotCG(file = "proSeq", type= 5, circular_plot = TRUE)
desolvation_plot
```
...
## Rppsc shiny app
`Rppsc` can also be accessed as a shiny app.
The app aims to show the visualization of the protein sequence composition with regard to 5 attributes. 
